package com.yilinker.core.v2.constants;
...
public class APIConstants {
    ...
    //Language
    public static final String LANGUAGE_API                                                         = "get-languages";
    public static final String LANGUAGE_PARAM_LANGUAGE_ID                                           = "language";
    ...
    public static final String PRODUCT_PARAM_COMPLETE_DESCRIPTION                                   = "description";
    public static final String PRODUCT_PARAM_VIDEO_URL                                              = "youtubeVideoUrl";
    public static final String PRODUCT_PARAM_CONDITION_ID                                           = "productConditionId";
    public static final String PRODUCT_PARAM_CATEGORY_ID                                            = "productCategoryId";
    public static final String PRODUCT_PARAM_SHIPPING_CATEGORY_ID                                   = "shippingCategoryId";
