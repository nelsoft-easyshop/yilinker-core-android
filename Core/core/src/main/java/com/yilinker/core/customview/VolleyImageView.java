...
/**
 * Created by jaybryantc on 2/19/16.
 */
public class VolleyImageView extends ImageView {

    /**
     * Reference : @link{http://stackoverflow.com/questions/20292588/how-to-get-finish-callback-on-setimageurl-with-volley-library-and-networkimagevi}
     */
    ...
    /**
     * Container of local bitmap
     */
    private Bitmap mLocalBitmap;

    /**
     * Flag for local bitmap
     */
    private boolean mShowLocal;

    /**
     * For imageview with corner radius
     */
